...
- **Edad como factor de vulnerabilidad directa**: activado en `_factores_calor`/`_factores_frio`. Calor: 65a×1.2, 75a×1.5, 85a×2.0. Frío: 65a×1.2, 75a×1.4, 85a×1.7. Se suma al factor edad de **ingeniería inversa** que ya aplica el ML en la `prob_poblacional` vía estratos (el modelo se entrenó con datos de mortalidad de MoMo donde la mayoría son >70 años, por lo que "sobreestima" el riesgo en jóvenes; el factor del ensemble reduce ese sesgo: 85a=1.0, menor edad=0.6–0.875).
